          ...
          {articles.map((article: any) => (
            <div key={article.id} className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text"><small className="text-muted">Author: {article.author}</small><br/><small>{article.publishedDate}</small></p>
                <a href={'/article/' + article.id} className="btn btn-primary align-items-center">More details</a>
              </div>
            </div>
          )) }
        </div>
